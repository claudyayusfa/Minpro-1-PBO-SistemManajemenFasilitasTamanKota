...
3. User dapat menampilkan data fasilitas dengan memilih menu 1.
  <img width="564" height="1136" alt="image" src="https://github.com/user-attachments/assets/559c804a-d21c-40ed-95f9-0661ec43b824" />

4. User dapat menambahkan data fasilitas dengan memilih menu 2.
...
5. User dapat menghapus data berdasarkan ID fasilitas di menu 3.
...
6. User dapat mengupdate data berdasarkan ID fasilitas di menu 4.
...
7. Data fasilitas disimpan menggunakan 'ArrayList'.
